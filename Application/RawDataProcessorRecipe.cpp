...
std::string RawDataProcessorRecipe::trimRow(std::string &row) {
...
std::string RawDataProcessorRecipe::alignRow(std::string &row) {
...
std::string RawDataProcessorRecipe::process(std::string &query) {
